            ...
            {isAuthenticated ? (
              <>
                ...
                <div className="relative" ref={profileRef}>
                  ...
                  {isProfileMenuOpen && (
                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-xl border overflow-hidden">
                      <ul>
                        <li className="px-4 py-2 text-sm text-gray-700 font-semibold border-b">
                          Hello, {user.username}!
                        </li>
                        <li>
                          <Link
